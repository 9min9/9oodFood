$('#createForum-form').on("submit",function (e) {
    e.preventDefault();
...
function onSubmitForm() {
    var formData = new FormData($('#createForum-form')[0]);
    $('div[id*="-errors"]').empty();
    ...
    $.ajax({
        type:"POST",
        url:"https://www.9oodfood.com/api/user/create/forum",
        contentType: false,
        processData: false,
        data: formData,
