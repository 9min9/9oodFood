...
const urlCategory = searchPath[2];
const urlLocation = searchPath[3];
...
function drawPage(page){
    if(flag){
        ...
        $.ajax({
            type:"post",
            url: "https://www.9oodfood.com/api/public/forum/list/sort/" + urlCategory +"/" +urlLocation,
            dataType:"JSON",
            async: false,
            contextType : "application/json",
            data: {moodOpt : moodArray, priceOpt : priceArray, subCategoryOpt : subCategoryArray, page : storeIndex},
